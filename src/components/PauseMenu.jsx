...
function PauseMenu({togglePaused, restartGame, quitGame}) {
  return (
    <div className='absolute w-screen h-screen top-0 left-0 | flex justify-center items-center'>
        ...
        <div className='relative z-[10] | flex flex-col items-center justify-around | w-11/12 h-[60%] md:w-3/4 md:h-3/4 lg:h-2/3 lg:w-1/3 | rounded-3xl | bg-purple | border-2 border-b-8 border-black border-solid'>

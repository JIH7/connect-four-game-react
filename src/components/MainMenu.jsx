...
function MainMenu({setGameState}) {
  return (
    <div className='h-full w-full | flex flex-col justify-center items-center'>
        ...
        <div className='z-10 | border-2 border-black border-solid | bg-purple | h-full w-full md:h-1/2 md:w-2/3 lg:h-2/3 lg:w-1/3 | md:rounded-3xl | flex flex-col justify-around items-center'>

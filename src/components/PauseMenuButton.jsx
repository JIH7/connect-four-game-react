...
function PauseMenuButton({text, color, handleClick}) {
  return (
    <div>
        <button className={`group relative | w-11/12 h-1/4 | my-2 | flex justify-between items-center | rounded-2xl | border-[3px] border-black hover:border-dark-purple border-solid  | ${color}`} onClick={handleClick}>
